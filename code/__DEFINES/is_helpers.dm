...
#define iszombie(A) (is_species(A, /datum/species/zombie) || HAS_TRAIT(A, TRAIT_UNDEAD)) //SPLURT Edit: Removes previously uncommented edit, adds a check for the undead trait in exchange
